...
for folder=1:4 % When changing it pay attention to all places where the variable "folder" is used
    ...
    dirs=dir(['C:\Users\mq20185770\Documents\MATLAB\Blake\Gorilla_visual_search_gray_non-targets_Cad_vs_NoCad\',folder_to_use{folder}]);
    ...
    for i=3:length(dirs)
        ...
        if folder==1 || folder==2
            mask_instrct_Target{1+d,1}='Red.png';
